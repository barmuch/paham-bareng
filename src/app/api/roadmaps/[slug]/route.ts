...
// Mock roadmap data with interactive graph
const MOCK_ROADMAPS: any = {
  'tauhid-dasar': {
    _id: '1',
    ...
    nodes: [
      {
        ...
        estimatedHours: 4,
        resources: [
          { title: 'Ringkasan konsep tauhid (artikel)', url: 'https://islamqa.info/en', type: 'article' },
        ],
      },
      {
        id: 't_2',
        label: 'Tiga Jenis Tauhid',
        description: 'Tauhid Rububiyyah, Uluhiyyah, dan Asma’ wa Sifat (gambaran umum).',
        type: 'topic',
      ...
      },
      {
        id: 't_3',
        label: 'Rububiyyah',
        description: 'Mengimani Allah sebagai Rabb: pencipta, pengatur, dan pemilik segala sesuatu.',
        type: 'subtopic',
      ...
      },
      {
        id: 't_4',
        label: 'Uluhiyyah',
        description: 'Memurnikan ibadah hanya kepada Allah (doa, tawakkal, nadzar, dll).',
        type: 'milestone',
      ...
      },
      {
        id: 't_5',
        label: 'Asma’ wa Sifat',
        description: 'Adab memahami nama dan sifat Allah: menetapkan tanpa tahrif/takyif/tamsil.',
        type: 'topic',
      ...
      {
        id: 't_6',
        label: 'Syirik Besar vs Syirik Kecil',
        description: 'Mengenali bentuk-bentuk syirik dan dampaknya terhadap amal.',
        type: 'checkpoint',
      ...
      {
        id: 't_7',
        label: 'Rukun Iman (Ringkas)',
        description: 'Iman kepada Allah, malaikat, kitab, rasul, hari akhir, qadar (overview).',
        type: 'topic',
      ...
      {
        id: 't_8',
        label: 'Adab Ikhtilaf & Menguatkan Iman',
        description: 'Cara belajar yang lurus: adab, bertanya pada ahlinya, dan menjaga hati.',
        type: 'milestone',
...
export async function GET(
  ...
  try {
    ...
    if (!useDatabase) {
      // Return mock data
      const mockRoadmap = MOCK_ROADMAPS[params.slug];
    ...
    await Roadmap.findByIdAndUpdate(roadmap._id, { $inc: { views: 1 } });
